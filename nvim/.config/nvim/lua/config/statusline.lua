...
local function diagnostics()
  ...
  if errs + warns > 0 then
    return string.format(" 󰅚 %d 󰛩 %d", errs, warns)
  end
  return ""
end
_G.diagnostics = diagnostics
-- Добавь highlight группы:
vim.api.nvim_set_hl(0, "StatusLineMode", { fg="#89b4fa", bold=true })
vim.api.nvim_set_hl(0, "StatusLineGit", { fg="#f9e2af" })
vim.api.nvim_set_hl(0, "StatusLineFile", { fg="#a6e3a1" })
